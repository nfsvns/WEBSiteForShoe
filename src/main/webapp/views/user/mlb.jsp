	...
	<div class="container py-5">
		<div class="row">
				<div style="text-align: center">
					<span
						style="text-align: center; font-weight: bold; font-size: 50px">MLB's
						Product</span>
				</div>
        ...
        <img class="img" style="width: 90%" src="${item.image}" alt="">
			...
			<ul class="pagination pagination-lg justify-content-end">
				<li class="page-item"><a
					...
					href="/mlb?p=0">&laquo;&laquo;</a></li>	
			     <li class="page-item"><a
					class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark"
					href="/mlb?p=${products.number-1}">&laquo;</a></li>
			     
				
				
					<li class="page-item"><a
					class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark"
					href="/mlb?p=${products.number+1}">&raquo;</a></li>
			
					<li class="page-item"><a
					class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark"
					href="/mlb?p=${products.totalPages-1}">&raquo;&raquo;</a></li>
			</ul>
		</div>
			</div>
		</div>
									...
									<div class="carousel-item active">
										<div class="row">
											<div class="col-3 p-md-5">
												<a href="#"><img
													class="img-fluid brand-img" src="assets/img/brand_01.png"
													alt="Brand Logo" /></a>
											</div>
											<div class="col-3 p-md-5">
												<a href="#"><img
													class="img-fluid brand-img" src="assets/img/brand_02.png"
													alt="Brand Logo" /></a>
											</div>
											<div class="col-3 p-md-5">
												<a href="#"><img
													class="img-fluid brand-img" src="assets/img/brand_03.png"
													alt="Brand Logo" /></a>
											</div>
											<div class="col-3 p-md-5">
												<a href="#"><img
													class="img-fluid brand-img" src="assets/img/brand_04.png"
													alt="Brand Logo" /></a>
											</div>
										</div>
									</div>
